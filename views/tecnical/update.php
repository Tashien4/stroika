...
<h2>Изменение типа техники</h2>
    <?php $form = ActiveForm::begin();
    $sp_tec=$model->find_tec($type_works);
    $sp_status=$model->find_stat(); ?>
<table>
    <tr>
        <td><?= $form->field($model, 'type')->dropDownList($sp_tec); ?></td>
   ...
   // 'convertFormat' => true,
    ...
    <tr>
        <td colspan=2><?php //echo $form->field($recmodel, 'status')->dropDownList($recmodel->list_status())->label('Статус запроса'); ?></td>
    </tr>    
